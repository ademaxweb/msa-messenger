...
const (
	UsersService_CreateProfile_FullMethodName           = "/github.com.ademaxweb.msa_messenger.users.api.users.v1.UsersService/CreateProfile"
	UsersService_UpdateProfile_FullMethodName           = "/github.com.ademaxweb.msa_messenger.users.api.users.v1.UsersService/UpdateProfile"
	UsersService_GetProfileByID_FullMethodName          = "/github.com.ademaxweb.msa_messenger.users.api.users.v1.UsersService/GetProfileByID"
	UsersService_GetProfileByNickname_FullMethodName    = "/github.com.ademaxweb.msa_messenger.users.api.users.v1.UsersService/GetProfileByNickname"
	UsersService_SearchProfileByNickname_FullMethodName = "/github.com.ademaxweb.msa_messenger.users.api.users.v1.UsersService/SearchProfileByNickname"
)
...
func (c *usersServiceClient) SearchProfileByNickname(ctx context.Context, in *SearchProfileByNicknameRequest, opts ...grpc.CallOption) (*SearchProfileByNicknameResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SearchProfileByNicknameResponse)
	err := c.cc.Invoke(ctx, UsersService_SearchProfileByNickname_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUsersServiceServer) GetProfileByNickname(context.Context, *GetProfileByNicknameRequest) (*GetProfileByNicknameResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetProfileByNickname not implemented")
}
func (UnimplementedUsersServiceServer) SearchProfileByNickname(context.Context, *SearchProfileByNicknameRequest) (*SearchProfileByNicknameResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SearchProfileByNickname not implemented")
}
...
func _UsersService_SearchProfileByNickname_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SearchProfileByNicknameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UsersServiceServer).SearchProfileByNickname(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UsersService_SearchProfileByNickname_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UsersServiceServer).SearchProfileByNickname(ctx, req.(*SearchProfileByNicknameRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UsersService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "github.com.ademaxweb.msa_messenger.users.api.users.v1.UsersService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SearchProfileByNickname",
			Handler:    _UsersService_SearchProfileByNickname_Handler,
		},
	},
